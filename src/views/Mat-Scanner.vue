...
export default {
  ...
  methods: {
    scanner() {
      ...
      gsap.set(".Lamp", { fill: "transparent" });

      gsap.utils.toArray(".Lamp").forEach((lamp, i) => {
